...
<body>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="custom-select" id="ACCOUNTNUM" name="ACCOUNTNUM" required>
                                                ...
                                                foreach ($vendor as $row):
                                                    ?>
                                                    <option value="<?= $row->ACCOUNTNUM; ?>"><?= $row->NAME; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="number" min="1"
                                                                    ...
                                                                    id="QTY<?= $row->INVENTTRANSID; ?>" class="qty-input">
                                                            </td>
                                                            <td>
                                                                <input type="number" min="1" name="subTotal" class="subTotal"
                                                                    value="0.00" readonly>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                        ...
                        <table>
                            ...
                            <?php foreach ($items as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="<?= $row->ITEMID; ?>" id="<?= $row->ITEMID; ?>"
                                            value="<?= $row->ITEMID; ?>" <?php if ($isChecked)
                                                  echo 'checked'; ?>>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
    ...
    <script>
        $(document).ready(function () {
            // Fungsi untuk menghitung subtotal pada baris tertentu
            ...
            // Menghitung subtotal awal saat halaman dimuat
            $('.qty-input').each(function () {
                calculateSubTotal($(this).closest('tr'));
            });

            // Menghitung ulang subtotal saat nilai QTY diubah
