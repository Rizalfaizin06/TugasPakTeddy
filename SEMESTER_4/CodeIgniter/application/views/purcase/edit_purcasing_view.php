                                                ...
                                                <div class="col-md-6 text-md-end">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <strong>
                                                                <?= $purcase[0]->PURCHID; ?>
                                                                <input type="hidden" name="PURCHID"
                                                                    value="<?= $purcase[0]->PURCHID; ?>">
                                                            </strong>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col text-md-end">
                                                            ...
                                                            <strong>
                                                                ...
                                                                <select class="custom-select" id="PURCHSTATUS"
                                                                    name="PURCHSTATUS" required>
                                                                    <option value="0" <?= ($purcase[0]->PURCHSTATUS == 0) ? 'selected' : '' ?>>Pending
                                                                    </option>
                                                                    <option value="1" <?= ($purcase[0]->PURCHSTATUS == 1) ? 'selected' : '' ?>>Done
                                                                    </option>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table border-bottom border-gray-200 mt-3">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col"
                                                                class="fs-sm text-dark text-uppercase-bold-sm px-0 p-1">
                                                                Line
                                                                Number</th>
                                                            <th scope="col"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="p-1">
                                                                    <input type="number" class="form-control"
                                                                        name="<?= $row->INVENTTRANSID; ?>PURCHRECEIVENOW"
                                                                        id="<?= $row->INVENTTRANSID; ?>PURCHRECEIVENOW"
                                                                        value="<?= $row->PURCHRECEIVEDNOW; ?>" min="0">
