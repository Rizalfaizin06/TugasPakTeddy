...
class Items extends CI_Controller
{
    ...
    public function add_new_items()
    {
        ...
        $this->load->view('items/add_items_view');
    }
    ...
    public function save_items()
    {
        ...
        if ($this->Items_model->save_items($ITEMNAME, $ITEMTYPE, $NAMEALIAS, $ITEMPRICE)) {
            redirect('items');
        } else {
    ...
    public function get_edit()
    {
        ...
        if ($result) {
            ...
            // $data['items'] = $this->Items_model->get_items()->result();
            // $data['items'] = $this->Items_model->get_items()->result();
            $this->load->view('items/edit_items_view', $data);
        } else {
    ...
    public function update_items()
    {
        ...
        if ($this->Items_model->update_items($ITEMID, $ITEMNAME, $ITEMTYPE, $NAMEALIAS, $ITEMPRICE)) {
            redirect('items');
        } else {
            $data['error'] = "Terjadi Kesalahan";
    ...
    public function get_delete()
    {
        ...
        if ($result) {
            ...
            // $data['items'] = $this->Items_model->get_items()->result();
            // $data['items'] = $this->Items_model->get_items()->result();
            $this->load->view('items/delete_items_view', $data);
        } else {
            echo "data tidak ditemukan";
        }
