            ...
            <div class="container">
                ...
                <div class="btn-group mb-3">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" target="_blank" href="<?= site_url('VendorController/pdf'); ?>">PDF</a>
                        <a class="dropdown-item" href="<?= site_url('VendorController/excel'); ?>">EXCEL</a>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <form action="<?= base_url() ?>VendorController/index" method="post">
                            <div class="d-flex flex-column text-center mb-2">
                                <h3>Filter Vendor</h3>
                            </div>
                            <div class="d-flex flex-sm-row flex-column justify-content-around">
                                <div class="flex-fill">
                                    <input type="text" name="searchACCOUNTNUM"
                                        value="<?= (isset($searchACCOUNTNUM)) ? $searchACCOUNTNUM : '' ?>"
                                        class="form-control" placeholder="Search Vendor Number">
                                    <!-- <input type="submit" name="submitACCOUNTNUM" value="submit" class="btn btn-primary"> -->
                                </div>
                                <div class="p-2"></div>
                                <div class="flex-fill">
                                ...
                                <div class="flex-fill">
                                    <input type="text" name="searchADDRESS"
                                        value="<?= (isset($searchADDRESS)) ? $searchADDRESS : '' ?>"
                                        class="form-control" placeholder="Search Vendor Address">
                                </div>
